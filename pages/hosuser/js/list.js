...
layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
								...
								,{checkbox:true}
                                ,{field:'hosUserName', width:90, title: '订餐用户名称', sort: true}
                                //,{field:'openid', width:90, title: '微信绑定ID', sort: true}
                                ,{field:'hosUserMobile', width:110, title: '订餐用户手机号', sort: true}
                                ,{field:'hosInpatient', width:90, title: '订餐用户病区', sort: true}
                                ,{field:'hosStorey', width:90, title: '订餐用户楼层', sort: true}
                                ,{field:'hosBedNumber', width:110, title: '订餐用户床位号', sort: true}
								,{field:'sortSq', width:90, title: '排序号', sort: true}
