...
layui.define('view', function(exports){
  ...
  //页面跳转hero
  $body.on('click', '*[hero-href]', function(){
    var othis = $(this)
    ,href = othis.attr('hero-href')
    ,text = othis.attr('hero-text')
    ,router = layui.router();
    
    var ahref = othis.attr('hero-href');
    console.log(ahref);
    $("input[name!='newsletter']")
    $('#objId', parent.document);
    parent.$(window.parent.document).find("a[data-url='"+ahref+"']").click();
  });
